...
namespace TrashCollector.Controllers
{
    public class PickupsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,PickupDate,DayOfWeekPickup,PickupStatus,PickupCharge,Zipcode,EmployeeId,CustomerId")] Pickup pickup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,PickupDate,DayOfWeekPickup,PickupStatus,PickupCharge,Zipcode,EmployeeId,CustomerId")] Pickup pickup)
        {
            if (ModelState.IsValid)
            {
